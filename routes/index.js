...
router.get('/', function (req, res) { 
    res.render('index', { title: 'intrested App', user : req.user }); 
}); 
 
router.get('/register', function(req, res) { 
    res.render('register', { title: 'intrested App Registration'}); 
}); 
...
router.get('/login', function(req, res) { 
    res.render('login', { title: 'intrested App Login', user : req.user }); 
}); 
